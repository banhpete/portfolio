...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF(
    "https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/chinese/model.gltf"
  ) as GLTFResult;
  return (
    <group ref={group} {...props} dispose={null}>
      <group rotation={[0, Math.PI / 2, 0]}>
        <mesh
          geometry={nodes.Mesh_chinese.geometry}
          material={materials.brownLight}
        />
        <mesh
          geometry={nodes.Mesh_chinese_1.geometry}
          material={materials.white}
        />
        <mesh
          geometry={nodes.Mesh_chinese_2.geometry}
          material={materials.red}
        />
        <mesh
          geometry={nodes.Mesh_chinese_3.geometry}
